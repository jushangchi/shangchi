...
<head>
  ...
  <title>密码找回</title>
  <link href="/static/Home/assets/css/bootstrap.css" rel="stylesheet">
  <!--    font-awesome -->
  <link rel="stylesheet" href="/static/Home/assets/css/font-awesome.css">
  <!-- style -->
                  ...
                  @endif
                    <div class="row">
                      ...
                      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group">
                          <span class="temp-span-wrap temp-span-input-label-wrap">
                            <input class="temp_input_field" type="text" name="email">
                            <label class="temp_input_label">
                      ...
                      <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
                        <div class="form-group">
                          <span class="temp-span-wrap temp-span-input-label-wrap">
                            <input class="temp_input_field" type="password" name="repassword">
                            <label class="temp_input_label">
                      ...
                      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group">
                          <span class="temp-span-wrap temp-span-input-label-wrap">
                            <input class="temp_input_field" type="text" name="fcode">
                            <label class="temp_input_label">
                              <span class="temp_input_label-content">输入验证码</span>
                            </label>
                          </span>
                        </div>
                      </div>
                      ...
                      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        {{csrf_field()}}
                          <button class="btn btn-info temp-form-button" type="submit">提交注册</button>
                        </div>
                      </div>
                    </div>
                  </form>
            ...
            <div class="row custom-row">
              ...
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="temp-form-column-wrap">
                  <h2>付款方式</h2>
                  <p>请提供下面的帐单和付款信息</p>
                  <img src="/static/Home/assets/images/payment.jpg" alt="background-image" class="img-responsive">
                  <form>
                    <div class="row">
                      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="form-group">
                  ...
                  <form action="/doforget" method="post">
                    <div class="row">
                      ...
                      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="temp-login-button-wrap">
                          {{csrf_field()}}
                          <button class="btn btn-info temp-form-button" type="submit">提交发送</button>
                        </div>
                      </div>
                    </div>
                  </form>
...
<script src="/static/Home/assets/js/bootstrap.js"></script>
<!-- custom js link -->
<!-- <script src="/static/Home/assets/js/form.js"></script> -->
