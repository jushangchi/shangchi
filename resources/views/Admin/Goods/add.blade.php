  ...
  <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12" style="width: 1440px;"> 
   <div class="panel panel-default bk-bg-white" > 
    ...
    <div class="panel-body"> 
     <form action="/good" method="post" enctype="multipart/form-data" class="form-horizontal "> 
    ...
    <div class="form-group"> 
      ...
      <div class="form-group"> 
       <label class="col-md-3 control-label" for="select">分类名称</label> 
       <div class="col-md-9"> 
        <select id="select" name="cate_id" class="form-control input-lg" size="1"> 
     ...
     <div class="form-group">
                      ...
                      <div class="col-md-9">
                        <div class="radio-custom radio-inline">
                          <input type="radio" id="inline-radio1" name="status" value="2"> 
