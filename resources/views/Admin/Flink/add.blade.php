  ...
  <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12" style="margin-left:400px"> 
   <div class="panel panel-default bk-bg-white"> 
    <div class="panel-heading bk-bg-white"> 
     <h6><i class="fa fa-indent red"></i>友情链接添加</h6> 
    ...
    <div class="panel-body"> 
     <form action="/flink" method="post"  class="form-horizontal "> 
      ...
      <div class="form-group"> 
       ...
       <div class="col-md-9"> 
        <input type="text" id="text-input" name="link" class="form-control" placeholder="Text" /> 
        <span class="help-block"></span> 
       </div> 
      </div> 
