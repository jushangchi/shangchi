  ...
  <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12" style="margin-left:400px"> 
   <div class="panel panel-default bk-bg-white"> 
    <div class="panel-heading bk-bg-white"> 
     <h6><i class="fa fa-indent red"></i>添加分类</h6> 
    ...
    <div class="panel-body"> 
     <form action="/admincates" method="post" enctype="multipart/form-data" class="form-horizontal "> 
      ...
      <div class="form-group"> 
       <label class="col-md-3 control-label" for="select">父类名称</label> 
       <div class="col-md-9"> 
        <select id="select" name="pid" class="form-control input-lg" size="1"> 
